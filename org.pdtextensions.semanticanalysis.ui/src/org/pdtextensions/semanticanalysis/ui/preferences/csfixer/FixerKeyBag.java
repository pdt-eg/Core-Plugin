...
public class FixerKeyBag implements LauncherKeyBag {
	...
	private final Key exeKey = new Key(PEXAnalysisUIPlugin.PLUGIN_ID, Keys.PHP_EXECUTABLE); 
	private final Key pharKey = new Key(PEXAnalysisUIPlugin.PLUGIN_ID, Keys.FIXER_PHAR); 
	private final Key useKey = new Key(PEXAnalysisUIPlugin.PLUGIN_ID, Keys.USE_PROJECT_PHAR); 
