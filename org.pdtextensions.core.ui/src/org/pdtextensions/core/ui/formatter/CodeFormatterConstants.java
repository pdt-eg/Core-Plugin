...
public class CodeFormatterConstants {
	 ...
	 * @see #FALSE
	 */
	public static final String FORMATTER_FORMAT_HTML_REGION = PEXUIPlugin.OPTION_ID
			+ ".formatter.format_html_region"; //$NON-NLS-1$
	 ...
	 * @see #FALSE
	 */
	public static final String FORMATTER_ALIGN_PHP_REGION_WITH_OPEN_TAG = PEXUIPlugin.OPTION_ID
			+ ".formatter.align_php_region_with_open_tag"; //$NON-NLS-1$
	 ...
	 * @see #FALSE
	 */
	public static final String FORMATTER_INDENT_BODY_DECLARATIONS_COMPARE_TO_NAMESPACE = PEXUIPlugin.OPTION_ID
			+ ".formatter.indent_body_declarations_compare_to_namespace"; //$NON-NLS-1$
	 ...
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_NAMESPACE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 *     - default:           INSERT
	 * </pre>
	 * @see PEXUIPlugin#INSERT
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER_IN_ARGUMENTS = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_new_line_after_opening_brace_in_array_initializer_in_arguments";//$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_NAMESPACE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_DOUBLE_ARROW_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_before_double_arrow_operator"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_DOUBLE_ARROW_OPERATOR_WITH_FILLER = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_before_double_arrow_operator_with_filler"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_DOUBLE_ARROW_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_after_double_arrow_operator"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_DOUBLE_COLON_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_before_double_colon_operator"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_DOUBLE_COLON_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_after_double_colon_operator"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OBJECT_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_before_object_operator"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OBJECT_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_after_object_operator"; //$NON-NLS-1$
	 ...
	 * @see PEXUIPlugin#DO_NOT_INSERT
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_ECHO = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_before_parenthesized_expression_in_echo"; //$NON-NLS-1$
	 ...
	 *     - default:           TRUE
	 * </pre>
	 * This option is used only if the option {@link #FORMATTER_ALIGNMENT_FOR_EXPRESSIONS_IN_ARRAY_INITIALIZER} is set.
	 * @see #TRUE
	 * @see #FALSE
	 */
	public static final String FORMATTER_WRAP_ARRAY_IN_ARGUMENTS = PEXUIPlugin.OPTION_ID
			+ ".formatter.wrap_array_in_arguments"; //$NON-NLS-1$
	 ...
	 * @since 1.2
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_CONCAT_EXPRESSION = PEXUIPlugin.OPTION_ID
			+ ".formatter.alignment_for_concat_expression"; //$NON-NLS-1$
	 ...
	 * @since 1.2
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CONCAT_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_before_concat_operator"; //$NON-NLS-1$
	 ...
	 * @since 1.2
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_CONCAT_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.insert_space_after_concat_operator"; //$NON-NLS-1$
	 ...
	 *     - default:           TRUE
	 * </pre>
	 * This option is used only if the option {@link #FORMATTER_ALIGNMENT_FOR_CONCAT_EXPRESSION} is set.
	 * @see #TRUE
	 * @see #FALSE
	 * @since 1.2
	 */
	public static final String FORMATTER_WRAP_BEFORE_CONCAT_OPERATOR = PEXUIPlugin.OPTION_ID
			+ ".formatter.wrap_before_concat_operator"; //$NON-NLS-1$
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGN_TYPE_MEMBERS_ON_COLUMNS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_EXPLICIT_CONSTRUCTOR_CALL = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_METHOD_INVOCATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_QUALIFIED_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.2
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_ASSIGNMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_BINARY_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_COMPACT_IF = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_CONDITIONAL_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_EXPRESSIONS_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_MULTIPLE_FIELDS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_PARAMETERS_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_PARAMETERS_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_SELECTOR_IN_METHOD_INVOCATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_SUPERCLASS_IN_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_SUPERINTERFACES_IN_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_THROWS_CLAUSE_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_ALIGNMENT_FOR_THROWS_CLAUSE_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_AFTER_IMPORTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_AFTER_PACKAGE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_AT_BEGINNING_OF_METHOD_BODY = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_FIELD = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_FIRST_CLASS_BODY_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_IMPORTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_MEMBER_TYPE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_METHOD = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_NEW_CHUNK = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BEFORE_PACKAGE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public static final String FORMATTER_BLANK_LINES_BETWEEN_IMPORT_GROUPS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BLANK_LINES_BETWEEN_TYPE_DECLARATIONS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_ANONYMOUS_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_BLOCK = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_BLOCK_IN_CASE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_SWITCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_BRACE_POSITION_FOR_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_JAVADOC_COMMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_BLOCK_COMMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public final static String FORMATTER_COMMENT_FORMAT_LINE_COMMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_COMMENT_FORMAT_LINE_COMMENT_STARTING_ON_FIRST_COLUMN = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public final static String FORMATTER_COMMENT_FORMAT_BLOCK_COMMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public final static String FORMATTER_COMMENT_FORMAT_JAVADOC_COMMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_FORMAT_HEADER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_FORMAT_HTML = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_FORMAT_SOURCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_INDENT_PARAMETER_DESCRIPTION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_INDENT_ROOT_TAGS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_INSERT_EMPTY_LINE_BEFORE_ROOT_TAGS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_INSERT_NEW_LINE_FOR_PARAMETER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public final static String FORMATTER_COMMENT_LINE_LENGTH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public final static String FORMATTER_COMMENT_NEW_LINES_AT_BLOCK_BOUNDARIES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public final static String FORMATTER_COMMENT_NEW_LINES_AT_JAVADOC_BOUNDARIES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_COMPACT_ELSE_IF = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_CONTINUATION_INDENTATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_CONTINUATION_INDENTATION_FOR_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_USE_ON_OFF_TAGS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_DISABLING_TAG = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_ENABLING_TAG = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INDENT_BODY_DECLARATIONS_COMPARE_TO_TYPE_HEADER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INDENT_BREAKS_COMPARE_TO_CASES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.2
	 */
	public static final String FORMATTER_INDENT_EMPTY_LINES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INDENT_STATEMENTS_COMPARE_TO_BLOCK = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INDENT_STATEMENTS_COMPARE_TO_BODY = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_CASES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_SWITCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INDENTATION_SIZE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_AFTER_LABEL = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_AT_END_OF_FILE_IF_MISSING = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_CATCH_IN_TRY_STATEMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_CLOSING_BRACE_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_ELSE_IN_IF_STATEMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_FINALLY_IN_TRY_STATEMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_BEFORE_WHILE_IN_DO_STATEMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ANONYMOUS_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_BLOCK = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_METHOD_BODY = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_NEW_LINE_AFTER_NAMESPACE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_AND_IN_TYPE_PARAMETER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_ASSIGNMENT_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_BINARY_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_BRACE_IN_BLOCK = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_PAREN_IN_CAST = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_ASSERT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_CASE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_CONDITIONAL = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_LABELED_STATEMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_CONSTRUCTOR_DECLARATION_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_CONSTRUCTOR_DECLARATION_THROWS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_EXPLICIT_CONSTRUCTOR_CALL_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_FOR_INCREMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_FOR_INITS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_DECLARATION_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_DECLARATION_THROWS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_INVOCATION_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_MULTIPLE_FIELD_DECLARATIONS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_MULTIPLE_LOCAL_DECLARATIONS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_SUPERINTERFACES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_ELLIPSIS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACKET_IN_ARRAY_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CAST = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CATCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_IF = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_INVOCATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_PARENTHESIZED_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SWITCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SYNCHRONIZED = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_WHILE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_POSTFIX_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_PREFIX_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_QUESTION_IN_CONDITIONAL = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_QUESTION_IN_WILDCARD = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_SEMICOLON_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_AFTER_UNARY_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_AND_IN_TYPE_PARAMETER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_ASSIGNMENT_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_BINARY_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACE_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACKET_IN_ARRAY_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CAST = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CATCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_IF = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_INVOCATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_PARENTHESIZED_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_SWITCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_SYNCHRONIZED = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_WHILE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_ASSERT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_CASE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_CONDITIONAL = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_DEFAULT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_LABELED_STATEMENT = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_CONSTRUCTOR_DECLARATION_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_CONSTRUCTOR_DECLARATION_THROWS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_EXPLICIT_CONSTRUCTOR_CALL_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_FOR_INCREMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_FOR_INITS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_DECLARATION_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_DECLARATION_THROWS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_INVOCATION_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_MULTIPLE_FIELD_DECLARATIONS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_MULTIPLE_LOCAL_DECLARATIONS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_SUPERINTERFACES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_ELLIPSIS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_TYPE_PARAMETERS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ANONYMOUS_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_BLOCK = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_SWITCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_TYPE_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_CATCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_IF = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_METHOD_INVOCATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_PARENTHESIZED_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_SWITCH = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_SYNCHRONIZED = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_WHILE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.2
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_RETURN = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_THROW = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_POSTFIX_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_PREFIX_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_QUESTION_IN_CONDITIONAL = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_QUESTION_IN_WILDCARD = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON_IN_FOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BEFORE_UNARY_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BETWEEN_BRACKETS_IN_ARRAY_TYPE_REFERENCE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_BRACES_IN_ARRAY_INITIALIZER = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_BRACKETS_IN_ARRAY_ALLOCATION_EXPRESSION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_CONSTRUCTOR_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_DECLARATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_INVOCATION = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_KEEP_ELSE_STATEMENT_ON_SAME_LINE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_KEEP_EMPTY_ARRAY_INITIALIZER_ON_ONE_LINE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_KEEP_GUARDIAN_CLAUSE_ON_ONE_LINE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_KEEP_SIMPLE_IF_ON_ONE_LINE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_KEEP_THEN_STATEMENT_ON_SAME_LINE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_LINE_SPLIT = PEXUIPlugin.OPTION_ID
			+ ".formatter.lineSplit"; //$NON-NLS-1$

	/**
	 * <pre>
	 * FORMATTER / Option to indent block comments that start on the first column
	 *     - option id:         "org.eclipse.jdt.core.formatter.never_indent_block_comments_on_first_column"
	 *     - possible values:   { TRUE, FALSE }
	 *     - default:           FALSE
	 * </pre>
	 ...
	 * @since 3.3
	 */
	public static final String FORMATTER_NEVER_INDENT_BLOCK_COMMENTS_ON_FIRST_COLUMN = PEXUIPlugin.OPTION_ID
	 ...
	 *     - option id:         "org.eclipse.jdt.core.formatter.never_indent_line_comments_on_first_column"
	 *     - possible values:   { TRUE, FALSE }
	 *     - default:           FALSE
	 * </pre>
	 * Note that:
	 ...
	 * @since 3.3
	 */
	public static final String FORMATTER_NEVER_INDENT_LINE_COMMENTS_ON_FIRST_COLUMN = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_NUMBER_OF_EMPTY_LINES_TO_PRESERVE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.5
	 */
	public static final String FORMATTER_JOIN_WRAPPED_LINES = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.5
	 */
	public static final String FORMATTER_JOIN_LINES_IN_COMMENTS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_PUT_EMPTY_STATEMENT_ON_NEW_LINE = PEXUIPlugin.OPTION_ID
	 ...
	 *
	 * @see PEXUIPlugin#TAB
	 * @see PEXUIPlugin#SPACE
	 * @see #MIXED
	 * @since 3.0
	 */
	public static final String FORMATTER_TAB_CHAR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.0
	 */
	public static final String FORMATTER_TAB_SIZE = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.1
	 */
	public static final String FORMATTER_USE_TABS_ONLY_FOR_LEADING_INDENTATIONS = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.3
	 */
	public static final String FORMATTER_WRAP_BEFORE_BINARY_OPERATOR = PEXUIPlugin.OPTION_ID
	 ...
	 * @since 3.6
	 */
	public static final String FORMATTER_WRAP_OUTER_EXPRESSIONS_WHEN_NESTED = PEXUIPlugin.OPTION_ID
	...
	public static Map getDefaultSettings() {
		return CodeFormatterOptions.getDefaultSettings().getMap();
	}
