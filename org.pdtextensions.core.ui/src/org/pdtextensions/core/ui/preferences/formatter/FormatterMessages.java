...
final class FormatterMessages extends NLS {
	...
	//XXX pdt_tools
	public static String IndentationTabPage_format_html_region;
	public static String IndentationTabPage_align_php_region_with_open_tag;
	public static String IndentationTabPage_class_group_option_indent_declarations_within_namespace;
	public static String BracesTabPage_option_namespace_declaration;
	public static String WhiteSpaceTabPage_classes_before_opening_brace_of_a_namespace;
	public static String WhiteSpaceOptions_namespace_decl;
	public static String WhiteSpaceOptions_echo;
	public static String WhiteSpaceOptions_echo_with_parenthesized_expression;
	public static String WhiteSpaceTabPage_operators_before_double_arrow_operator_with_filler;
	public static String WhiteSpaceTabPage_operators_before_double_arrow_operator;
	public static String WhiteSpaceTabPage_operators_after_double_arrow_operator;
	public static String WhiteSpaceOptions_double_arrow_operator;
	public static String WhiteSpaceOptions_double_arrow_operator_with_filler;
	public static String WhiteSpaceOptions_before_double_arrow;
	public static String WhiteSpaceOptions_after_double_arrow;
	public static String WhiteSpaceTabPage_operators_before_double_colon_operator;
	public static String WhiteSpaceTabPage_operators_after_double_colon_operator;
	public static String WhiteSpaceOptions_double_colon_operator;
	public static String WhiteSpaceOptions_before_double_colon;
	public static String WhiteSpaceOptions_after_double_colon;
	public static String WhiteSpaceTabPage_operators_before_object_operator;
	public static String WhiteSpaceTabPage_operators_after_object_operator;
	public static String WhiteSpaceOptions_object_operator;
	public static String WhiteSpaceOptions_before_object_operator;
	public static String WhiteSpaceOptions_after_object_operator;
	public static String NewLinesTabPage_array_group_option_after_opening_brace_of_array_initializer_in_arguments;
	public static String LineWrappingTabPage_wrap_array_in_arguments;
	// since 1.2
	public static String LineWrappingTabPage_concat_exprs;
	public static String LineWrappingTabPage_concat_expression_wrap_operator;
	public static String WhiteSpaceTabPage_operators_before_concat_operator;
	public static String WhiteSpaceTabPage_operators_after_concat_operator;
	public static String WhiteSpaceOptions_concat_operator;
	public static String WhiteSpaceOptions_before_concat_operator;
	public static String WhiteSpaceOptions_after_concat_operator;
