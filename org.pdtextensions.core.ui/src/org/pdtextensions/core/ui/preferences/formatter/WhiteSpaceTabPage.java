...
import org.pdtextensions.core.ui.preferences.formatter.WhiteSpaceOptions.InnerNode;
import org.pdtextensions.core.ui.preferences.formatter.WhiteSpaceOptions.Node;
import org.pdtextensions.core.ui.preferences.formatter.WhiteSpaceOptions.OptionNode;
...
public class WhiteSpaceTabPage extends FormatterTabPage {
	...
	private final class SyntaxComponent implements ISelectionChangedListener,
		...
		private final String PREF_NODE_KEY = PEXUIPlugin.PLUGIN_ID
	...
	private final class JavaElementComponent implements
		...
		private final String PREF_INNER_INDEX = PEXUIPlugin.PLUGIN_ID
				+ ".formatter_page.white_space.java_view.inner"; //$NON-NLS-1$
		private final String PREF_OPTION_INDEX = PEXUIPlugin.PLUGIN_ID
		...
		public JavaElementComponent() {
			...
			fTree = new WhiteSpaceOptions()
					.createTreeByPHPElement(fWorkingValues);
			WhiteSpaceOptions.makeIndexForNodes(fTree, fIndexedNodeList);
		}
	...
	private final class SwitchComponent extends SelectionAdapter {
		private final String PREF_VIEW_KEY = PEXUIPlugin.PLUGIN_ID
