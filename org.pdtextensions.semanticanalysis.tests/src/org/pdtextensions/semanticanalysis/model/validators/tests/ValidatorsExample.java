...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>validators</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ValidatorsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ValidatorsPackage.eNS_URI, 
			 ValidatorsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.validators"));
				Validator root = ValidatorsFactory.eINSTANCE.createValidator();
